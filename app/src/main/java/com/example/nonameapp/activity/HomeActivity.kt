...
//    override fun onItemClick(isVisible: Boolean) {
//        val navController = findNavController(binding.fragmentAllFunction.id)
//        val currentDestination = navController.currentDestination
//
//        if (currentDestination?.id == R.id.homeFragment || currentDestination?.id == R.id.exerciseTestFragment) {
//            binding.linearLayout.visibility = if (isVisible) View.VISIBLE else View.GONE
//        }
//    }
